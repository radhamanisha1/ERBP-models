...
parser.add_argument('--save', type=str, default='abs-trans.pt',
...
#datasets = ['data_jogoslav']
#context_len = [10,20]
epochs = 10
# Loop over epochs.
#lr = args.lr
#best_val_loss = None
fr = open('abs_results.txt', 'w')
#change based on model/etc
...
main_func(datasets,context_len,epochs)
